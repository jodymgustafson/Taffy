/// <reference path="system.byte.ts" />
/// <reference path="convert.ts" />
module System
{
    "use strict";

    /** A  immutable color object */
    export class Color
    {
        protected r: number;
        protected g: number;
        ...
        /** @param s hexadecimal, shorthand hex, rgb() or rgba() */
        ...
        * @param shorthandReturnAcceptable If true will return #333 instead of #333333
        ...
        */
        public toHex(shorthandAcceptable = false): string
        {
            ...
            if (shorthandAcceptable) { this._hex.replace(/^#([\da-f])\1([\da-f])\2([\da-f])\3$/i, "#$1$2$3"); }
            return this._hex;
        }
        ...
        {
            return isFinite(this.r + this.g + this.b);
        }
